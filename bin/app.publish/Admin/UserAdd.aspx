<%@ Page Title="Add User - MediConnect" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="UserAdd.aspx.cs" Inherits="MediConnect.Admin.UserAdd" %>
    ...
    <div class="card w-100">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator CssClass="text-danger text-small" ID="RequiredFieldValidator3" runat="server" ErrorMessage="*Required" ControlToValidate="Password" Display="Dynamic"></asp:RequiredFieldValidator>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <asp:Button CssClass="btn btn-primary" ID="CreateUserButton" runat="server" Text="Create" OnClick="CreateUserButton_Click" />
